...
SUMMARY_SYSTEM_PROMPT = (
    ...
    "- This channel discusses college athletes, recruits, and transfer portal "
    "players. When messages reference athletes or coaches by name, ALWAYS include "
    ...
    "other sports (baseball, soccer, NFL, NBA, etc.), pop culture, news, memes, "
    "politics, video games, technology, or personal discussion. If no basketball or "
    "football topics exist, return only the Announcements section (if any) or an "
    "empty summary.\n"
